...
// public var rightController : SteamVR_TrackedObject;

// private var RightController : SteamVR_Controller.Device;



function Update () {
    //  RightController = SteamVR_Controller.Input(rightController.index);
    // Debug.Log(RightController.velocity);
